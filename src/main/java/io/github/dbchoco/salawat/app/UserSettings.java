...
public class UserSettings {
    ...
    public static String adhanPath = prefs.get("adhanPath", "Bismillah"); //TODO
    public static Boolean customAdhan = prefs.getBoolean("customAdhan", false);
    public static String customAdhanPath = prefs.get("customAdhanPath", "TODO"); //TODO
    public static Boolean customFajrAdhan = prefs.getBoolean("customFajrAdhan", false);
    public static String customFajrAdhanPath = prefs.get("customFajrAdhanPath", "TODO"); //TODO
    ...
    public static Integer fajrAngle = prefs.getInt("fajrAngle", 0); //TODO MAKE IT DOUBLE
    ...
    public static Integer ishaAngle = prefs.getInt("ishaAngle", 0);
