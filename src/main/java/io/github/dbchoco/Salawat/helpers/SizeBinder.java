...
public class SizeBinder {
    private static ObjectProperty<Font> fontSmall = new SimpleObjectProperty<Font>(Font.getDefault());
    private static ObjectProperty<Font> fontMedium = new SimpleObjectProperty<Font>(Font.getDefault());
    private static ObjectProperty<Font> fontLarge = new SimpleObjectProperty<Font>(Font.getDefault());
    private static ObjectProperty<Font> fontLarger = new SimpleObjectProperty<Font>(Font.getDefault());
    private static Integer smallFontRatio = 35;
    private static Integer mediumFontRatio = 25;
    private static Integer largeFontRatio = 18;
    private static Integer largerFontRatio = 10;
